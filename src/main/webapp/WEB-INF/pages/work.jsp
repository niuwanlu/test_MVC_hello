...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/styles/workpage.css" />
</head>
<body>
    <div id="container">
      <div id="menu">
